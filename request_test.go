...
func TestRequest(t *testing.T) {
	t.Run("GET request", func(t *testing.T) {
		...
		if res.StatusCode != 200 {
			t.Fatalf("Response failed, invalid status: %s", res.Status)
		}
	...
	t.Run("GET request with GetURL method", func(t *testing.T) {
		parsedURL, _ := url.Parse("https://httpbin.org/get")

		res, err := New().GetURL(parsedURL)
		if err != nil {
			t.Fatalf("Error making GET request: %v", err)
		}
	...
	t.Run("GET redirected request", func(t *testing.T) {
		res, err := New().Get("https://httpbin.org/redirect/1")
		if err != nil {
			t.Fatalf("Error making GET request: %v", err)
		}
	...
	t.Run("GET request with dynamic Header", func(t *testing.T) {
		req := New()
	...
	t.Run("POST request with JSON data", func(t *testing.T) {
		res, err := New().Body(testData).Post("https://httpbin.org/post")
		if err != nil {
	...
	t.Run("PUT request with JSON data", func(t *testing.T) {
		res, err := New().Body(testData).Put("https://httpbin.org/put")
		if err != nil {
	...
	t.Run("PATCH request with JSON data", func(t *testing.T) {
		res, err := New().Body(testData).Patch("https://httpbin.org/patch")
		if err != nil {
			t.Fatalf("Error making PUT request: %v", err)
		}
	...
	t.Run("OPTIONS request with Do method", func(t *testing.T) {
		res, err := New().Do("OPTIONS", "https://httpbin.org/get")
		if err != nil {
			t.Fatalf("Error making DELETE request: %v", err)
		}
